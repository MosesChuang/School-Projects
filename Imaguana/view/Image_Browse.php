<!doctype html>
    <head>
        ...
        <title>Imaguana | Shop</title>
        <BASE href="http://localhost/~s16g09/"> 
    ...
    <div class="ws-topbar" id="home">
        <div class="pull-left">
            <div class="ws-topbar-message hidden-xs">
                <p>Find the <span>perfect image</span> you are looking for!<span></span></p> 
            </div>
        </div>
...
<!-- Account -->
                <li class="ws-shop-account">
                    <a href="#ws-register-modal" data-toggle="modal" class="btn btn-sm">Login/ Sign Up</a>
                </li> 
            </ul>     
        </div>
    </div> 
               ...
               <!-- Links -->
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-left">
                        <li><a href="/~s16g09/#home">Home</a></li>
                        <li><a href="/~s16g09/#about">About US</a></li>
                        <li><a>Browse All</a></li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right">        
                        
                        <li><a href="#ws-register-modal" data-toggle="modal" class="btn btn-sm">My Account</a></li> 
                        
                        <li><a href="/~s16g09/#contact">Contact</a></li>  
                        <li class="dropdown">
                            <a href="#x" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-animations="fadeIn">Information <span class="caret"></span></a>
    ...
    <div class="container ws-page-container">
        <div class="ws-works-title clearfix">
            <div class="col-sm-12">
                <h3 style="font-size: 55px">Shop</h3> 
        ...
        <div class="row">            
            <div class="ws-shop-page">                
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation"><a href="#illustrated" aria-controls="illustrated" role="tab" data-toggle="tab">Illustrated Prints (18)</a></li>
                    <li role="presentation"><a href="#journals" aria-controls="journals" role="tab" data-toggle="tab">Journals (6)</a></li>
                    <li role="presentation"><a href="#sale" aria-controls="sale" role="tab" data-toggle="tab">Sale (33)</a></li>                    
                </ul>
                
                <!-- Search Bar -->
                <form style="text-align: center" class="ws-shop-cart">
                    <input  style="color: black; height:43px; width: 250px; font-size:25px;" type="text" placeholder="Search here..." required>
                         <a style="height: 40px" href="#x" class="btn ws-big-btn">Search</a>
                </form>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade in active" id="all">   
                        ...
                        <!-- Item -->
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="images/4.html">
                                <!-- Image -->                        
                                <figure>                            
                                    <img src="assets/img/works/illustrated/1.jpg" alt="Alternative Text" class="img-responsive">
                                </figure>
                                <div class="ws-works-caption text-center">
                                    <!-- Item Category -->
                                    <div class="ws-item-category">Illustrated Prints</div>
                                    ...
                                    <!-- Title -->
                                    <h3 class="ws-item-title">Flamingo</h3>                        
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="images/5.html">
                                ...
                                <div class="ws-works-caption text-center">
                                    ...
                                    <!-- Title -->
                                    <h3 class="ws-item-title">Colossal</h3>                        
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">
                                <div class="ws-item-offer">
                                    <!-- Image -->                        
                                    <figure>                            
                                        <img src="assets/img/works/illustrated/3.jpg" alt="Alternative Text" class="img-responsive">
                                    </figure>                                   
                                </div>
                                <div class="ws-works-caption text-center">
                                    <!-- Item Category -->
                                    ...
                                    <!-- Price -->
                                    <div class="ws-item-price">$10.00</div>                        
                                </div>
                            </a>
                        </div>                           
                    ...
                    <!-- Abstract Prints -->
                    <div role="tabpanel" class="tab-pane fade" id="prints">
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">                        
                                ...
                                <div class="ws-works-caption text-center">
                                    ...
                                    <!-- Price -->
                                    <div class="ws-item-price">$25.00</div>                                                    
                                </div>
                            </a>
                        </div>                        
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">                        
                                ...
                                <div class="ws-works-caption text-center">
                                    <!-- Item Category -->
                                    <div class="ws-item-category">Big Sea</div>
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">
                                ...
                                <div class="ws-works-caption text-center">
                                    ...
                                    <!-- Title -->
                                    <h3 class="ws-item-title">Long Desert</h3>                        

                                    <div class="ws-item-separator"></div>    

                                    <!-- Price -->
                                    <div class="ws-item-price">$65.00</div>                        
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">
                                ...
                                <div class="ws-works-caption text-center">
                                    ...
                                    <!-- Title -->
                                    <h3 class="ws-item-title">Desert</h3>                        

                                    <div class="ws-item-separator"></div>    

                                    <!-- Price -->
                                    <div class="ws-item-price">$15.00</div>                        
                                </div>
                            </a>
                        </div>
                    ...
                    <!-- Illustrated Prints -->
                    <div role="tabpanel" class="tab-pane fade" id="illustrated">   
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">
                                ...
                                <div class="ws-works-caption text-center">
                                    ...
                                    <!-- Title -->
                                    <h3 class="ws-item-title">Pink Flamingo</h3>                        
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">
                                ...
                                <div class="ws-works-caption text-center">
                                    ...
                                    <!-- Title -->
                                    <h3 class="ws-item-title">Ghost Mountains</h3>                        

                                    <div class="ws-item-separator"></div>    

                                    <!-- Price -->
                                    <div class="ws-item-price">$44.00</div>                        
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">
                                ...
                                <div class="ws-works-caption text-center">
                                    ...
                                    <!-- Price -->
                                    <div class="ws-item-price">$92.00</div>                        
                                </div>
                            </a>
                        </div>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="journals"> 
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">
                                <!-- Image -->                        
                                <figure>                            
                                    <img src="assets/img/works/journals/1.jpg" alt="Alternative Text" class="img-responsive">
                                </figure>
                                <div class="ws-works-caption text-center">
                                    <!-- Item Category -->
                                    <div class="ws-item-category">Journals</div>
                                    ...
                                    <!-- Title -->
                                    <h3 class="ws-item-title">Yellow Laguna</h3>                        

                                    <div class="ws-item-separator"></div>    

                                    <!-- Price -->
                                    <div class="ws-item-price">$43.00</div>                        
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">
                                ...
                                <div class="ws-works-caption text-center">
                                    ...
                                    <!-- Title -->
                                    <h3 class="ws-item-title">twinkle twinkle</h3>                        

                                    <div class="ws-item-separator"></div>    

                                    <!-- Price -->
                                    <div class="ws-item-price">$13.00</div>                        
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">
                                <!-- Image -->                        
                                <figure>                            
                                    <img src="assets/img/works/journals/5.jpg" alt="Alternative Text" class="img-responsive">
                                </figure>
                                <div class="ws-works-caption text-center">
                                    <!-- Item Category -->
                                    <div class="ws-item-category">Journals</div>
                                    ...
                                    <!-- Title -->
                                    <h3 class="ws-item-title">White Pantera</h3>                        

                                    <div class="ws-item-separator"></div>    

                                    <!-- Price -->
                                    <div class="ws-item-price">$93.00</div>                        
                                </div>
                            </a>
                        </div>  
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">
                                <div class="ws-item-offer">
                                    <!-- Image -->                        
                                    <figure>                            
                                        <img src="assets/img/works/journals/6.jpg" alt="Alternative Text" class="img-responsive">
                                    </figure>                    
                                </div>
                                <div class="ws-works-caption text-center">
                                    <!-- Item Category -->
                                    ...
                                    <!-- Title -->
                                    <h3 class="ws-item-title">Green Apple</h3>                        
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">
                                ...
                                <div class="ws-works-caption text-center">
                                    ...
                                    <!-- Title -->
                                    <h3 class="ws-item-title">Honey Beer</h3>                        
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">
                                ...
                                <div class="ws-works-caption text-center">
                                    ...
                                    <!-- Price -->
                                    <div class="ws-item-price"><del>$43.00</del> <ins>$22.00</ins></div>                        
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">                        
                                ...
                                <div class="ws-works-caption text-center">
                                    ...
                                    <!-- Title -->
                                    <h3 class="ws-item-title">New Desert</h3>                        

                                    <div class="ws-item-separator"></div>    

                                    <!-- Price -->
                                    <div class="ws-item-price"><del>$150.00</del> <ins>$75.00</ins></div>                                                    
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">                        
                                ...
                                <div class="ws-works-caption text-center">
                                    ...
                                    <!-- Title -->
                                    <h3 class="ws-item-title">Red Flowers</h3>                        

                                    <div class="ws-item-separator"></div>    

                                    <!-- Price -->
                                    <div class="ws-item-price"><del>$94.00</del> <ins>$52.00</ins></div>                                                    
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 ws-works-item">
                            <a href="#">                        
                                ...
                                <div class="ws-works-caption text-center">
                                    ...
                                    <!-- Title -->
                                    <h3 class="ws-item-title">Pink Martini</h3>                        

                                    <div class="ws-item-separator"></div>    

                                    <!-- Price -->
                                    <div class="ws-item-price"><del>$250.00</del> <ins>$125.00</ins></div>                                                    
                                </div>
                            </a>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            ...
                                            <div class="modal-footer">
                                                <!-- Button -->
                                                <a class="btn ws-btn-fullwidth">Login</a>                                    
                                                <br>
                                                <!-- Link -->
                                                <div class="ws-register-link">
                                                    <a href="#ws-login-modal" data-toggle="modal" tabindex="1" >Don't have an account? Sign up here.</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row">                                             
                ...
                <div class="col-sm-6 ws-footer-col">                            
                    ...
                    <div class="ws-footer-about">
                        <p>Imaguana is an image hosting website that allows you to purchase the license of an  artist’s image. Imaguana has several advantages over competitors since its strength lies in its easy to use interface, its user focused design for both artists and customers, and its eye pleasing visuals</p>
                    </div>
                </div>
                ...
                <div class="col-sm-2 ws-footer-col">                    
                    ...
                    <ul>
                        ...
                        <li><a href="shop.html">Search Catalog</a></li>
                        <li><a href="/#featuredImagesA">Featured Images</a></li>     
                        <li><a href="/#featuredCategoriesA">Featured Categories</a></li> 
                    </ul>                    
                </div>  
