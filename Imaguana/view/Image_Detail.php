...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Artday - Creative Shop Template</title>
...
<!-- Account -->
                ...
                <li>
                    <form class="ws-shop-cart">
                        <input  style="color: black; height:36px; width: 200px; font-size:20px;" type="text" placeholder="Search here..." required>
                    </form>
                </li> 
                <!-- Search -->
                <li class="ws-shop-cart">
                    <a href="#x" class="btn btn-sm">Search</a>                            
                </li>  
            </ul>     
        </div>
    </div> 
    ...
    <div class="ws-breadcrumb">
        <div class="container">
            <ol class="breadcrumb">
                <li><a href="#">Shop</a></li>
                <li><a href="#">Illustrated Prints</a></li>
        ...
        <div class="row">
            ...
            <div class="col-sm-7">        
                <div id="ws-products-carousel" class="owl-carousel">
                    <div class="item">
                        ...
                        <img src=<?php echo "\"$image->image\"";  ?> class="img-responsive" alt="Alternative Text" height="700">
                    </div>      
                </div>
            </div>
            ...
            <div class="col-sm-5">
                <div class="ws-product-content">
                    <header>
                        <!-- Title -->
                        <h3 class="ws-item-title"><?php echo "$image->title"; ?></h3>                        
                    ...
                    <!-- Price -->
                        ...
                        `   <div>
                                ...
                                <label for="radio1">Print License</label>
                            </div>
                            ...
                            <div>	
                                ...
                                <label for="radio3">Unlimited License</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Button -->                         
                    <a class="btn ws-btn-fullwidth">Buy Now</a><br><br><br>                   
                </div>
            </div>              
        </div>              
    </div>    
                ...
                <div class="ws-works-item">
                    <a href="6.html">
                        ...
                        <div class="ws-works-caption text-center">
                            ...
                            <!-- Title -->
                            <h3 class="ws-item-title">Mars Exploring</h3>                        
                ...
                <div class="ws-works-item">
                    <a href="7.html">
                        ...
                        <div class="ws-works-caption text-center">
                            ...
                            <!-- Title -->
                            <h3 class="ws-item-title">Smudge Mountains</h3>                       
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div class="ws-works-item">
                    <a href="8.html">
                        ...
                        <div class="ws-works-caption text-center">
                            ...
                            <!-- Title -->
                            <h3 class="ws-item-title">Princess World</h3>                        
